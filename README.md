...
A private, browser-based ebook converter for GitHub Pages. Drop in an EPUB and download a new EPUB or MOBI focus-reading edition that emphasizes the opening half of each word.

## Features

- Drag-and-drop or native file browser
- EPUB input
- EPUB-to-EPUB and EPUB-to-MOBI focus-mode output
...
EPUB-to-EPUB conversion preserves the original package, styles, images, metadata, and navigation while changing readable text nodes. EPUB-to-MOBI uses a compatibility-oriented, text-focused path and may simplify advanced layout and imagery. MOBI input and DRM-protected books are not supported.
